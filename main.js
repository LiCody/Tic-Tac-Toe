    ...
    */
    function moveCount(board){
        ...
        for (let i = 0; i<board[j].length; i++){
            for (let i = 0; i<board[i].length; j++){
                if(board[i][j]!=""){
                    moveCount++;
                }
            }
    ...
    */
    function getBestMove (board, symbol){
        ...
        */
        ...
        let availableMoves = getAvailableMove(board)
        let availabeMovesAndScores = [];
        ...
        for (var i = 0; i < availableMoves,length; i++){
            ...
            if (result = RESULT.tie) {score = 0}
                ...
                score = -(getBestMove(newBoard, otherSymbol).score);
            }
        ...
        availabeMovesAndScores.sort((moveA, moveB ) =>{
            return moveB.score - moveA.score;
        })
        return availableMovesAndScore[0];
    }
    /*
    ...
    */
    function render(){
        ...
        function htmlGame(){
            ...
            const playerName = state.game.turn === 0 ? 'Player1' : state.player[1].isComputer ? 'Computer' : 'Player2'
        ...
        let html = ''
        if (state.view == VIEW.symbolSelect) {html = htmlQ1()}
